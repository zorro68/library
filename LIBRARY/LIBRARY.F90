...
!--------------------------------------------------------
    ...
    ! GET THE INTEGER PART OF THE NUMBER
	    DO I=1,IIN
		    K=ICHAR(STR1(I:I))-48
		    STRTOQUAD=STRTOQUAD+REAL(K,16)*10.Q0**REAL(IIN-I,16)
        ENDDO
...
! --------------------------------------------------------------
    FUNCTION REALSTOSTR(NUMBER)
	    REAL*4 NUMBER
        CHARACTER*100 CVALUE
        CHARACTER(LEN=:), ALLOCATABLE :: REALSTOSTR 
        
        ALLOCATE(CHARACTER(LEN=LEN(CVALUE)) :: REALSTOSTR)
                
	    REALSTOSTR=""
	    WRITE(CVALUE,*)NUMBER
	    REALSTOSTR=TRIM(ADJUSTL(CVALUE))
    END
    
    FUNCTION REALDTOSTR(NUMBER)
	    REAL*8 NUMBER
        CHARACTER*100 CVALUE
        CHARACTER(LEN=:), ALLOCATABLE :: REALDTOSTR 
        
        ALLOCATE(CHARACTER(LEN=LEN(CVALUE)) :: REALDTOSTR)
    ...
    FUNCTION REALQTOSTR(NUMBER)
	    REAL*16 NUMBER
        CHARACTER*100 CVALUE
        CHARACTER(LEN=:), ALLOCATABLE :: REALQTOSTR 

        ALLOCATE(CHARACTER(LEN=LEN(CVALUE)) :: REALQTOSTR)
        
	    REALQTOSTR=""
	    WRITE(CVALUE,*)NUMBER
	    REALQTOSTR=TRIM(ADJUSTL(CVALUE))
    END
...
! --------------------------------------------------------------------------
    FUNCTION INTTOSTR(NUMBER)
        ...
        ALLOCATE(CHARACTER(LEN=LEN(CVALUE)) :: INTTOSTR)
