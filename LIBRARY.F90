...
MODULE MOD_FACT
    ...
    PUBLIC FACT, FACTI
    PRIVATE FACT_I4,FACT_I8,SFACT,DFACT,QFACT
    PRIVATE FACTI_I4,FACTI_I8,SFACTI,DFACTI,QFACTI

    INTERFACE FACT
        MODULE PROCEDURE FACT_I4,FACT_I8,SFACT,DFACT,QFACT
    END INTERFACE

    INTERFACE FACTI
        MODULE PROCEDURE FACTI_I4,FACTI_I8,SFACTI,DFACTI,QFACTI
    END INTERFACE
